...
expInfo = {u'session': u't', u'domEye': u'r', u'participant': u'', u'thresh': u'',
           u'training': u'0'}
...
conditionsFilePath = 'cond-files'+os.sep+'cond-bcfs-demo'+'.csv'
...
print commonNTrials
trials = data.TrialHandler(conds, commonNTrials, 'sequential', extraInfo=expInfo)

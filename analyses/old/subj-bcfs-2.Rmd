...
ggplot(ds[ds$Condition=='cm'&ds$maskSpeed!=3.5,], aes(x=maskSpeed, y=RTna_mean, group=SubjID, colour=SubjID)) +  geom_line() + geom_point()
ggplot(ds[ds$Condition=='dm'&ds$maskSpeed!=3.5,], aes(x=maskSpeed, y=RTna_mean, group=SubjID, colour=SubjID)) +  geom_line() + geom_point()
# Line plots of normalized RTs
ggplot(ds[ds$Condition=='cm'&ds$maskSpeed!=3.5,], aes(x=maskSpeed, y=RTna_norm, group=SubjID, colour=SubjID)) +  geom_line() + geom_point()
ggplot(ds[ds$Condition=='dm'&ds$maskSpeed!=3.5,], aes(x=maskSpeed, y=RTna_norm, group=SubjID, colour=SubjID)) +  geom_line() + geom_point()
# Box plots of normalized RTs
ggplot(ds[ds$maskSpeed!=3.5,], aes(x=maskSpeed, y=RTna_norm, colour=Condition)) +  geom_boxplot()
```
